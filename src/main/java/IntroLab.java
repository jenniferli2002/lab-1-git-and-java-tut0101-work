...
public class IntroLab {
    ...
    /**
     * Returns a message greeting for Sujoy Deb Nath using the printLabMessage method
     * with Sujoy's details.
     *
     * @return A greetings message.
     */
    public static String debnat17(){
        return printLabMessage("Hi", "Sujoy Deb Nath", true,
                "Happy to be here!");
    }
